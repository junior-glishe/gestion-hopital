...
class Chambre extends Model
{
    ...
    {
        return (int) $this->db->query("SELECT COUNT(*) FROM chambres")->fetchColumn();
    }
    public function compterLibres(): int
    {
        return (int) $this->db->query("SELECT COUNT(*) FROM chambres WHERE occupee = 0")->fetchColumn();
    }
