...
<style>
  ...
  <main>
        ...
        <div class="flex flex-col lg:flex-row items-center gap-10">
          <div class="flex-1 text-center lg:text-left">
            <span class="inline-block bg-white/60 backdrop-blur-sm rounded-full px-4 py-1.5 text-sm font-medium text-primary mb-5">
              Gestion hospitalière simplifiée
            </span>
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
              <a href="index.php?p=connexion/login" class="px-6 py-3 bg-primary text-white rounded-xl font-medium hover:bg-primary/90 transition text-center">
                Accès au système
              </a>
              <a href="index.php?p=connexion/inscription" class="px-6 py-3 border border-primary/30 rounded-xl font-medium text-primary hover:bg-primary hover:text-white transition text-center">
                Créer un compte
              </a>
            </div>
          </div>
    ...
    <section id="features" class="py-20 bg-white">
      <div class="max-w-7xl mx-auto px-4">
        <div class="text-center max-w-2xl mx-auto mb-12">
          <span class="text-primary font-semibold text-sm uppercase tracking-wide bg-primary/10 px-4 py-1.5 rounded-full">Nos services</span>
    ...
    <section id="whom" class="py-20 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4">
        <div class="text-center max-w-2xl mx-auto mb-12">
          <span class="text-primary font-semibold text-sm uppercase tracking-wide bg-primary/10 px-4 py-1.5 rounded-full">Acteurs</span>
    ...
    <section id="stats" class="py-20 bg-white">
      <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-16">
          <span class="text-primary font-semibold text-sm uppercase tracking-wide bg-primary/10 px-4 py-1.5 rounded-full inline-block mb-4">Chiffres clés</span>
    ...
    <section id="testimonies" class="py-20 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4">
        <div class="text-center max-w-2xl mx-auto mb-12">
          <span class="text-primary font-semibold text-sm uppercase tracking-wide bg-primary/10 px-4 py-1.5 rounded-full">Ils nous font confiance</span>
      ...
      <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            ...
            <li><a href="#" class="text-gray-400 hover:text-primary transition">Contactez-nous</a></li>
          </ul>
        </div>
