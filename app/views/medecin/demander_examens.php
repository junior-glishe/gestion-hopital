...
<?php $titre = "Demander examens - MediTrace"; ob_start(); ?>
<style>
    body {
  ...
  <div class="flex">
    <!-- Sidebar (identique avec active sur Demander examens) -->
    <aside class="w-72 bg-white shadow-lg min-h-screen sticky top-0">
      ...
      <nav class="p-4">
        ...
        <a href="index.php?p=medecin/demander_examens" class="sidebar-item active flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-700 mb-1">
    ...
    <main class="flex-1">
      <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="flex items-center gap-2 text-sm text-gray-500 mb-6">
          ...
          <span class="text-gray-800 font-medium">Demander des examens</span>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8">
          <div class="flex items-center gap-3 mb-6">
            ...
            <h1 class="text-xl md:text-2xl font-bold text-gray-800">Demander des examens</h1>
          </div>
...
<?php /* CSRF */ ?><input type="hidden" name="_csrf" value="<?= htmlspecialchars($csrf_token ?? '', ENT_QUOTES) ?>">
            ...
            <div class="border rounded-xl p-4">
              <div class="flex justify-between items-center mb-3">
                <h3 class="font-medium text-gray-800">Examen 1</h3>
              ...
              <div class="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select name="examen1" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl input-focus transition bg-white">
                    <option value="">Sélectionnez</option>
                    <option value="prise_sang">Prise de sang</option>
                    <option value="radiographie">Radiographie</option>
                    <option value="ecographie">Échographie</option>
                    <option value="scanner">Scanner</option>
                    <option value="irm">IRM</option>
                    <option value="ecg">Électrocardiogramme</option>
                    <option value="test_allergie">Test d'allergie</option>
                  </select>
                </div>
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-1">Date souhaitée *</label>
                  <input type="date" name="date_examen1" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl input-focus transition bg-white">
                </div>
              </div>
              <div class="mt-3">
                <label class="block text-sm font-medium text-gray-700 mb-1">Indications</label>
                <textarea name="indications1" rows="2" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl input-focus transition bg-white" placeholder="Informations cliniques à communiquer au laboratoire..."></textarea>
              </div>
            </div>

            <!-- Bouton ajouter examen -->
            <button type="button" class="w-full py-2 border border-dashed border-gray-300 rounded-xl text-gray-500 text-sm hover:border-purple-500 hover:text-purple-600 transition">
              + Ajouter un examen
            </button>
            ...
            <div>
              <label class="flex items-center gap-2">
                <input type="checkbox" class="w-4 h-4 rounded border-gray-300 text-red-600">
                <span class="text-sm text-gray-700">Examen urgent (résultat attendu dans les 24h)</span>
              </label>
            </div>
