...
<?php $titre = "Dashboard Médecin - MediTrace"; ob_start(); ?>
<style>
    body {
      ...
      <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="bg-gradient-to-r from-blue-700 to-blue-600 rounded-2xl p-6 md:p-8 text-white mb-8 shadow-xl">
          <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <h1 class="text-2xl md:text-3xl font-bold">Bonjour, Dr .....</h1>
              <p class="text-blue-100 mt-1">Bienvenue sur votre espace médecin MediTrace</p>
              <p class="text-blue-100/70 text-sm mt-2">Spécialité : <span class="font-medium">.....</span></p>
            </div>
