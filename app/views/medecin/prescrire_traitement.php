...
<?php $titre = "Prescrire traitement - MediTrace"; ob_start(); ?>
<style>
    body {
  ...
  <div class="flex">
    ...
    <aside class="w-72 bg-white shadow-lg min-h-screen sticky top-0">
      ...
      <nav class="p-4">
        ...
        <a href="index.php?p=medecin/prescrire_traitement" class="sidebar-item active flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-700 mb-1">
    ...
    <main class="flex-1">
      <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="flex items-center gap-2 text-sm text-gray-500 mb-6">
          ...
          <span class="text-gray-800 font-medium">Prescrire un traitement</span>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8">
          <div class="flex items-center gap-3 mb-6">
            ...
            <h1 class="text-xl md:text-2xl font-bold text-gray-800">Prescrire un traitement</h1>
          </div>
          ...
          <!-- Allergies patient -->
          <div class="bg-yellow-50 rounded-xl p-3 mb-6 border border-yellow-200">
            <div class="flex items-start gap-2">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#ca8a04" stroke-width="1.8"><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></svg>
              <p class="text-sm text-yellow-800"><span class="font-semibold">Allergies connues :</span> .....</p>
            </div>
          </div>
...
<?php /* CSRF */ ?><input type="hidden" name="_csrf" value="<?= htmlspecialchars($csrf_token ?? '', ENT_QUOTES) ?>">
            ...
            <div class="border rounded-xl p-4">
              <div class="flex justify-between items-center mb-3">
                <h3 class="font-medium text-gray-800">Médicament 1</h3>
                <button type="button" class="text-red-500 text-xs hover:underline">Supprimer</button>
              </div>
              <div class="grid md:grid-cols-2 gap-4">
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-1">Médicament *</label>
                  <input type="text" name="medicament1" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl input-focus transition bg-white" placeholder="Nom du médicament">
                </div>
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-1">Posologie *</label>
                  <input type="text" name="posologie1" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl input-focus transition bg-white" placeholder="Ex: 2 comprimés par jour">
                </div>
              </div>
              <div class="grid md:grid-cols-2 gap-4 mt-3">
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-1">Durée</label>
                  <input type="text" name="duree1" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl input-focus transition bg-white" placeholder="Ex: 7 jours">
                </div>
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-1">Voie d'administration</label>
                  <select name="voie1" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl input-focus transition bg-white">
            ...
            <button type="button" class="w-full py-2 border border-dashed border-gray-300 rounded-xl text-gray-500 text-sm hover:border-green-500 hover:text-green-600 transition">
            ...
            <div>
              ...
              <textarea name="instructions" rows="3" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl input-focus transition bg-white" placeholder="Recommandations, précautions..."></textarea>
            </div>

            <!-- Date de début -->
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">Date de début du traitement *</label>
              <input type="date" name="date_debut" required class="w-full px-4 py-2.5 border border-gray-200 rounded-xl input-focus transition bg-white">
            </div>
