...
<?php $titre = "Planifier hospitalisation - MediTrace"; ob_start(); ?>
<style>
    body {
  ...
  <div class="flex">
    <!-- Sidebar (identique avec active sur Planifier hospitalisation) -->
    <aside class="w-72 bg-white shadow-lg min-h-screen sticky top-0">
      ...
      <nav class="p-4">
        ...
        <a href="index.php?p=medecin/planifier_hospitalisation" class="sidebar-item active flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-700 mb-1">
    ...
    <main class="flex-1">
      <div class="max-w-3xl mx-auto px-4 py-8">
        ...
        <div class="flex items-center gap-2 text-sm text-gray-500 mb-6">
          ...
          <span class="text-gray-800 font-medium">Planifier une hospitalisation</span>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8">
          <div class="flex items-center gap-3 mb-6">
            ...
            <h1 class="text-xl md:text-2xl font-bold text-gray-800">Planifier une hospitalisation</h1>
          </div>
...
<?php /* CSRF */ ?><input type="hidden" name="_csrf" value="<?= htmlspecialchars($csrf_token ?? '', ENT_QUOTES) ?>">
            <div>
              ...
              <select name="patient" required class="w-full px-4 py-2.5 border border-gray-200 rounded-xl input-focus transition bg-white">
                ...
                <option value="patient1">Jean ADANDE</option>
                <option value="patient2">Marie ZINSOU</option>
              </select>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select name="chambre" required class="w-full px-4 py-2.5 border border-gray-200 rounded-xl input-focus transition bg-white">
                  ...
                  <option value="101">101 - Standard (25 000 FCFA/jour)</option>
                  <option value="102">102 - Standard (25 000 FCFA/jour)</option>
                  <option value="201">201 - Double (40 000 FCFA/jour)</option>
                  <option value="301">301 - VIP (75 000 FCFA/jour)</option>
                </select>
              </div>
            </div>
            ...
            <div>
              ...
              <textarea name="motif" rows="3" required class="w-full px-4 py-2.5 border border-gray-200 rounded-xl input-focus transition bg-white" placeholder="Raison médicale..."></textarea>
            </div>

            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">Diagnostic présumé</label>
              <input type="text" name="diagnostic" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl input-focus transition bg-white">
            </div>
