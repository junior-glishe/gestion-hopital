...
<?php $titre = "Dashboard Administrateur - MediTrace"; ob_start(); ?>
<style>
    body {
      ...
      <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="overflow-x-auto">
              <table class="w-full text-sm">
                <thead class="bg-gray-50">
                  <tr><th class="px-3 py-2 text-left">Nom</th><th class="px-3 py-2 text-left">Date</th><th class="px-3 py-2 text-left">Statut</th></tr>
                </thead>
                <tbody class="divide-y">
                  <tr><td class="px-3 py-2">.....</td><td class="px-3 py-2">.....</td><td class="px-3 py-2"><span class="px-2 py-1 bg-green-100 text-green-700 rounded-full text-xs">Actif</span></td></tr>
                  <tr><td class="px-3 py-2">.....</td><td class="px-3 py-2">.....</td><td class="px-3 py-2"><span class="px-2 py-1 bg-green-100 text-green-700 rounded-full text-xs">Actif</span></td></tr>
                  <tr><td class="px-3 py-2">.....</td><td class="px-3 py-2">.....</td><td class="px-3 py-2"><span class="px-2 py-1 bg-green-100 text-green-700 rounded-full text-xs">Actif</span></td></tr>
                </tbody>
              </table>
          ...
          <div class="bg-white rounded-xl shadow-sm p-5">
            ...
            <div class="space-y-3">
              <div><div class="flex justify-between text-sm mb-1"><span>Chambres occupées</span><span>.....</span></div><div class="w-full bg-gray-200 rounded-full h-2"><div class="bg-green-600 h-2 rounded-full" style="width: ....%"></div></div></div>
              <div><div class="flex justify-between text-sm mb-1"><span>Chambres disponibles</span><span>.....</span></div><div class="w-full bg-gray-200 rounded-full h-2"><div class="bg-blue-600 h-2 rounded-full" style="width: ....%"></div></div></div>
            </div>
          </div>
        </div>
