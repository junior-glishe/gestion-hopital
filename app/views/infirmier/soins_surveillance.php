...
<?php $titre = "Soins et surveillance - MediTrace"; ob_start(); ?>
<style>
    body {
  ...
  <div class="flex">
    ...
    <aside class="w-72 bg-white shadow-lg min-h-screen sticky top-0">
      ...
      <nav class="p-4">
        ...
        <a href="index.php?p=infirmier/soins_surveillance" class="sidebar-item active flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-700 mb-1">
    ...
    <main class="flex-1">
      <div class="max-w-3xl mx-auto px-4 py-8">
        ...
        <div class="flex items-center gap-2 text-sm text-gray-500 mb-6">
          ...
          <span class="text-gray-800 font-medium">Soins et surveillance</span>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8">
          <div class="flex items-center gap-3 mb-6">
            <div class="w-10 h-10 bg-teal-100 rounded-xl flex items-center justify-center">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#0d9488" stroke-width="1.8"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9H21"/><path d="M9 21V9"/></svg>
            </div>
            <h1 class="text-xl md:text-2xl font-bold text-gray-800">Soins et surveillance</h1>
          </div>
...
<?php /* CSRF */ ?><input type="hidden" name="_csrf" value="<?= htmlspecialchars($csrf_token ?? '', ENT_QUOTES) ?>">
            <!-- Type de soin -->
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">Type de soin *</label>
              <select name="type_soin" required class="w-full px-4 py-2.5 border border-gray-200 rounded-xl input-focus transition bg-white">
                <option value="">Sélectionnez un type de soin</option>
                <option value="panement">Pansement</option>
                <option value="injection">Injection</option>
                <option value="perfusion">Perfusion</option>
                <option value="medicament">Administration médicament</option>
            ...
            <!-- Description -->
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">Description du soin *</label>
              <textarea name="description" rows="3" required class="w-full px-4 py-2.5 border border-gray-200 rounded-xl input-focus transition bg-white" placeholder="Détail du soin effectué..."></textarea>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <input type="date" name="date" required class="w-full px-4 py-2.5 border border-gray-200 rounded-xl input-focus transition bg-white">
              </div>
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Heure *</label>
                <input type="time" name="heure" required class="w-full px-4 py-2.5 border border-gray-200 rounded-xl input-focus transition bg-white">
              </div>
            </div>

            <!-- Observation patient -->
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">Observation / État du patient *</label>
              <textarea name="observation" rows="3" required class="w-full px-4 py-2.5 border border-gray-200 rounded-xl input-focus transition bg-white" placeholder="État général, comportement, évolution..."></textarea>
            </div>

            <!-- Prochain soin -->
            <div class="grid md:grid-cols-2 gap-4">
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Prochain soin prévu</label>
                <input type="date" name="prochain_soin" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl input-focus transition bg-white">
              </div>
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">À</label>
                <input type="time" name="prochain_heure" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl input-focus transition bg-white">
              </div>
            </div>
        ...
        <!-- Liste des soins récents -->
        <div class="bg-white rounded-2xl shadow-xl p-6 mt-6">
          <h3 class="font-semibold text-gray-800 mb-4">Derniers soins administrés</h3>
          <div class="space-y-3">
            <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
              <div>
                <p class="text-sm font-medium text-gray-800">Patient : .....</p>
                <p class="text-xs text-gray-500">Soin : ..... - Observations : .....</p>
              </div>
