...
<?php $titre = "Dashboard Infirmier - MediTrace"; ob_start(); ?>
<style>
    body {
      ...
      <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="bg-gradient-to-r from-teal-700 to-teal-600 rounded-2xl p-6 md:p-8 text-white mb-8 shadow-xl">
          <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <h1 class="text-2xl md:text-3xl font-bold">Bonjour, .....</h1>
              <p class="text-teal-100 mt-1">Bienvenue sur votre espace infirmier MediTrace</p>
              <p class="text-teal-100/70 text-sm mt-2">Service : <span class="font-medium">.....</span></p>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-5">
          ...
          <div class="space-y-3">
            <div class="flex items-center justify-between p-3 bg-red-50 rounded-lg border border-red-100">
              <div>
                <p class="text-sm font-medium text-red-800">Patient : .....</p>
                <p class="text-xs text-red-600">Constantes anormales - Tension élevée</p>
              </div>
              <span class="text-xs text-red-500">.....</span>
            </div>
            <div class="flex items-center justify-between p-3 bg-yellow-50 rounded-lg border border-yellow-100">
              <div>
                <p class="text-sm font-medium text-yellow-800">Patient : .....</p>
                <p class="text-xs text-yellow-600">Demande de soins urgents</p>
              </div>
