...
<?php $titre = "Réinitialisation mot de passe - MediTrace"; ob_start(); ?>
<style>
  ...
  <div class="max-w-md mx-auto px-4">
    <div class="bg-white rounded-2xl shadow-xl p-8">
      <div class="text-center mb-8">
        ...
        <h1 class="text-2xl font-bold text-gray-800">Nouveau <span class="text-green-700">mot de passe</span></h1>
        <p class="text-gray-500 text-sm mt-1">Entrez votre nouveau mot de passe</p>
      </div>
