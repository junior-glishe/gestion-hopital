...
<?php $titre = "Payer facture - MediTrace"; ob_start(); ?>
<style>
    body {
  ...
  <div class="flex">
    ...
    <aside class="w-72 bg-white shadow-lg min-h-screen sticky top-0">
      ...
      <nav class="p-4">
        ...
        <a href="index.php?p=patient/payer_facture" class="sidebar-item active flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-700 mb-1">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
    ...
    <main class="flex-1">
      <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="flex items-center gap-2 text-sm text-gray-500 mb-6">
          ...
          <span class="text-gray-800 font-medium">Payer facture</span>
        </div>
        ...
        <div class="flex items-center gap-3 mb-6">
          ...
          <h1 class="text-xl md:text-2xl font-bold text-gray-800">Payer mes factures</h1>
        </div>

        <!-- Résumé des factures -->
        <div class="bg-gradient-to-r from-red-50 to-rose-50 rounded-xl p-4 mb-6 border border-red-100">
          <div class="flex justify-between items-center flex-wrap gap-3">
            ...
            <div>
              <p class="text-sm text-gray-600">Nombre de factures impayées</p>
              <p class="text-xl font-bold text-gray-800">.....</p>
            </div>
            <div>
              <p class="text-sm text-gray-600">Dernier délai de paiement</p>
              <p class="text-sm font-medium text-gray-700">.....</p>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-4">
          ...
          <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-200">
            <div class="p-4 border-b border-gray-100">
              <div class="flex justify-between items-center flex-wrap gap-3">
                <div>
                  <p class="text-xs text-gray-500">N° Facture</p>
                ...
                <span class="px-3 py-1 bg-red-100 text-red-700 text-xs rounded-full font-medium">Impayée</span>
              </div>
            </div>
            <div class="p-4">
              <div class="space-y-2">
                <div class="flex justify-between py-2 border-b border-gray-100">
                  <span class="text-sm text-gray-600">Consultation du .....</span>
                  <span class="text-sm text-gray-800">.....</span>
                </div>
                <div class="flex justify-between py-2 border-b border-gray-100">
                  <span class="text-sm text-gray-600">Examens médicaux</span>
                  <span class="text-sm text-gray-800">.....</span>
                </div>
                <div class="flex justify-between py-2 border-b border-gray-100">
                ...
                <div class="flex justify-between py-2 font-semibold">
                  <span class="text-sm text-gray-800">Montant total</span>
              ...
              <div class="mt-4 pt-3 border-t border-gray-100">
                <div class="flex justify-between items-center">
                  <div>
                    <p class="text-xs text-gray-500">Assurance : <span class="text-gray-700">.....</span></p>
                    <p class="text-xs text-gray-500 mt-1">Montant pris en charge : <span class="text-green-700">.....</span></p>
                  </div>
                  <button class="px-5 py-2 bg-red-600 text-white rounded-lg text-sm font-medium hover:bg-red-700 transition">
                    Payer maintenant
                  </button>
                </div>
              </div>
          ...
          <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-200">
            ...
            <div class="p-4">
              <div class="space-y-2">
                <div class="flex justify-between py-2 border-b border-gray-100">
                  <span class="text-sm text-gray-600">Hospitalisation (.....)</span>
                  <span class="text-sm text-gray-800">.....</span>
                </div>
                <div class="flex justify-between py-2 border-b border-gray-100">
                  <span class="text-sm text-gray-600">Frais de séjour</span>
                  <span class="text-sm text-gray-800">.....</span>
                </div>
                <div class="flex justify-between py-2 font-semibold">
                  <span class="text-sm text-gray-800">Montant total</span>
          ...
          <!-- Facture 3 - Payée -->
          <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100 opacity-80">
            <div class="p-4 border-b border-gray-100 bg-gray-50">
              <div class="flex justify-between items-center flex-wrap gap-3">
                ...
                <div>
                  <p class="text-xs text-gray-500">Date de paiement</p>
                  <p class="text-sm text-gray-700">.....</p>
                </div>
                <span class="px-3 py-1 bg-green-100 text-green-700 text-xs rounded-full font-medium">Payée</span>
              </div>
            </div>
            <div class="p-4">
              <div class="flex justify-between items-center">
                <div>
                  ...
                  <p class="text-xs text-gray-500 mt-1">Payé par : <span class="text-gray-700">.....</span></p>
                </div>
                <a href="#" class="text-green-700 text-sm hover:underline">Télécharger reçu</a>
              </div>
            </div>
          </div>
        ...
        <div class="mt-6 bg-white rounded-xl shadow-sm p-5">
          ...
          <div class="flex flex-wrap gap-4">
            ...
            <div class="flex items-center gap-2 px-3 py-2 bg-gray-50 rounded-lg">
              ...
              <span class="text-sm text-gray-600">Virement bancaire</span>
            </div>
            <div class="flex items-center gap-2 px-3 py-2 bg-gray-50 rounded-lg">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#4b5563" stroke-width="1.5">
                <circle cx="12" cy="12" r="10"/>
              ...
              <span class="text-sm text-gray-600">Espèces (à l'accueil)</span>
            </div>
          </div>
        </div>
