...
<?php $titre = "Dashboard Patient - MediTrace"; ob_start(); ?>
<style>
    body {
        ...
        <div class="bg-gradient-to-r from-green-700 to-green-600 rounded-2xl p-6 md:p-8 text-white mb-8 shadow-xl">
          <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              ...
              <p class="text-green-100/70 text-sm mt-2">N° patient : <span class="font-medium">.....</span></p>
            </div>
          ...
          <div class="bg-white rounded-xl shadow-sm p-5">
            ...
            <div class="space-y-3">
              <div class="flex justify-between items-center pb-3 border-b border-gray-100">
                ...
                <span class="px-2 py-1 bg-yellow-100 text-yellow-700 text-xs rounded-full">.....</span>
              </div>
              <div class="flex justify-between items-center">
                <div>
                  <p class="text-sm font-medium text-gray-800">.....</p>
                ...
                <span class="px-2 py-1 bg-green-100 text-green-700 text-xs rounded-full">.....</span>
              </div>
            </div>
          </div>
        </div>
