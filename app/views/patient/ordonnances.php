...
<?php $titre = "Mes ordonnances - MediTrace"; ob_start(); ?>
<style>
    body {
  ...
  <div class="flex">
    ...
    <aside class="w-72 bg-white shadow-lg min-h-screen sticky top-0">
      ...
      <nav class="p-4">
        ...
        <a href="index.php?p=patient/ordonnances" class="sidebar-item active flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-700 mb-1">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
            <path d="M4 4H20V20H4V4Z"/>
            <path d="M8 12H16"/>
            <path d="M12 8V16"/>
    ...
    <main class="flex-1">
      <div class="max-w-5xl mx-auto px-4 py-8">
        ...
        <div class="flex items-center gap-2 text-sm text-gray-500 mb-6">
          ...
          <span class="text-gray-800 font-medium">Mes ordonnances</span>
        </div>
        ...
        <div class="flex items-center gap-3 mb-6">
          ...
          <h1 class="text-xl md:text-2xl font-bold text-gray-800">Mes ordonnances</h1>
        </div>
          ...
          <div class="bg-white rounded-xl shadow-sm overflow-hidden">
            <div class="bg-gradient-to-r from-green-50 to-emerald-50 p-4 border-b border-green-100">
              <div class="flex justify-between items-center flex-wrap gap-3">
                ...
                <a href="#" class="flex items-center gap-2 px-4 py-2 bg-white rounded-lg text-sm text-green-700 hover:bg-green-50 transition">
            ...
            <div class="p-4">
              <p class="text-sm font-medium text-gray-700 mb-2">Médicaments prescrits :</p>
              <div class="space-y-2">
              ...
              <div class="mt-3 pt-3 border-t border-gray-100">
                <p class="text-xs text-gray-500">Durée du traitement : <span class="text-gray-700">.....</span></p>
                <p class="text-xs text-gray-500 mt-1">Recommandations : <span class="text-gray-700">.....</span></p>
              </div>
            </div>
          </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-8 text-center">
          ...
          <p class="text-xs text-gray-400 mt-1">Les ordonnances apparaîtront ici après vos consultations</p>
        </div>
